...
class ResultPage extends StatefulWidget {
  const ResultPage(
      {super.key, required this.information, required this.crop, this.isViewOnly = false});
...
class _ResultPageState extends State<ResultPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final keyStyle = const TextStyle(color: Color(0xff888888), fontSize: 14);
    final valueStyle = const TextStyle(color: Colors.white, fontSize: 14);
                ...
                children: [
                  ...
                  Text(widget.crop,
                      style: const TextStyle(
                          ...
                          overflow: TextOverflow.ellipsis)),
                  Center(
                    child: Image.file(File(widget.crop), fit: BoxFit.cover,),
                  )
                ],
              ),
            ),
